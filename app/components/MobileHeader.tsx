...
export function MobileHeader({
  ...
  return (
    <header className="lg:hidden h-14 flex items-center gap-2 px-3 border-b border-slate-800 bg-slate-950/95 backdrop-blur sticky top-0 z-30">
      <button
        onClick={onOpenMenu}
        className="w-9 h-9 rounded-lg bg-amber-500 hover:bg-amber-400 active:bg-amber-500 flex items-center justify-center text-slate-950 font-black text-sm shrink-0 transition-colors"
        title="Menú"
      >
        A
      </button>
